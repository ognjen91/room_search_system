...
<div class="er_wrap">
    ...
    <div class="er_edit_data">
           <h4 id="er_see_calendars"><a href="<?php echo SITE_ADRESS; ?>/admin/additional_pages/room_calendars.php?room=<?php echo $room->name; ?>&facility=<?php echo $room->facility_name; ?>&owner=<?php echo $room->owner; ?>">POGLEDAJTE I MIJENJAJTE SLOBODNE TERMINE, CIJENE I POPUSTE</a></h4>
        <form method="POST" action="" enctype="multipart/form-data">
            <p>Naziv sobe: <span id="er_room_name"><?php echo $active_room->name; ?></span>
            <p>Objekat: <span id="er_room_facility"><?php echo $active_room->facility_name; ?></span>
            <p>Vlasnik: <span id="er_room_owner"><?php echo $active_room->owner; ?></span>
                <p>
                    <br> Klima uredjaj:
  ...
  <option class="er_other_value"></option>
   ...
   <?php echo $active_room->description_eng; ?>
    ...
    <div class="er_images">
        ...
        <h4 id="er_add_new_img"><a href="<?php echo SITE_ADRESS; ?>/admin/additional_pages/add_room_image.php?room=<?php echo $room->name; ?>&facility=<?php echo $room->facility_name; ?>&owner=<?php echo $room->owner; ?>">DODAJTE NOVE SLIKE SOBE</a></h4>
<?php $calendar = new Calendar(); ?>
<?php $prices = new Prices(); ?>
<!--    <?php $calendar->test(); ?>-->
    <?php $prices->test2(); ?>
<!--    <?php var_dump($prices->april_prices); ?>-->
<?php
...
?>
        <?php require "add_includes/er_images.php"; ?>
